...
class ContactPoint:
    ...
    def contact_point_calculation(self, object_size = 39, object_pose = [0.0,0.0,0.0], finger_points = [[0.0,0.0],[1.0,0.0]], joint_angles = [0.0, 0.0], distal_length = 72, sleeve_length = 30):
        ...
        object = self.create_object_segments(object_size, object_pose)
        ...
        # Determine the correct distance to pass in (between joint and red line)
        ...
        dist = distal_length - sleeve_length + spacing

        # Get contact point in distal frame
        contact_delta = self.calculate_contact_delta(finger_points, dist, contact_point)
...
if __name__ == "__main__":
    ...
    contact.contact_point_calculation()
